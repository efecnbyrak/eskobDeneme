    ...
    <div className="container-main" style={{ paddingTop: 64, paddingBottom: 80, maxWidth: 760 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 40, lineHeight: 1.8, color: 'var(--color-text)' }}>
        <section>
          ...
          <p>
            Müşteri Vitrin'e müşteri olarak kayıt olabilmek için 18 yaşını doldurmuş olmanız gerekmektedir.
        ...
        <section>
          ...
          <p>
            Müşteri Vitrin, bakım, güncelleme veya teknik sorunlar nedeniyle geçici hizmet kesintileri
