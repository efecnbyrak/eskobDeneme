    ...
    <div className="container-main" style={{ paddingTop: 64, paddingBottom: 80, maxWidth: 760 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 40, lineHeight: 1.8, color: 'var(--color-text)' }}>
        <section>
          ...
          <p>
            Esnaf Vitrin, Türkiye&apos;deki esnaf ve KOBİ&apos;lerin dijital ortamda vitrin oluşturmasına, hizmetlerini tanıtmasına ve randevu yönetimi yapmasına olanak tanıyan bir platformdur. Platformumuzu kullanarak bu şartları kabul etmiş sayılırsınız.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Randevular, işletme ve kullanıcı arasında yapılan karşılıklı bir anlaşmadır. Esnaf Vitrin, randevu süreçlerinde aracı konumunda olup uyuşmazlıklarda taraf tutmaz. İptal ve iade koşulları her işletme tarafından ayrıca belirlenir.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Bakım, teknik arıza veya mücbir sebep halleri nedeniyle hizmetin geçici olarak kesintiye uğrayabileceğini önceden bildiririz. Bu durumlardan kaynaklanabilecek zararlardan Esnaf Vitrin sorumlu tutulamaz.
          </p>
        </section>
