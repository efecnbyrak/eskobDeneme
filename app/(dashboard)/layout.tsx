        ...
        <div className="flex-1 min-w-0 overflow-auto flex flex-col">
          ...
          <div className="lg:hidden sticky top-0 z-30 bg-slate-900 border-b border-slate-800 px-4 h-14 flex items-center justify-between">
            ...
            <nav className="flex items-center gap-1">
              <a href="/isletme/panel" className="p-2 rounded-lg hover:bg-slate-800 transition-colors text-slate-400" title="Genel Bakış">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                </svg>
              </a>
              <a href="/isletme/panel/randevular" className="p-2 rounded-lg hover:bg-slate-800 transition-colors text-slate-400" title="Randevular">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </a>
              <a href="/isletme/panel/ayarlar" className="p-2 rounded-lg hover:bg-slate-800 transition-colors text-slate-400" title="Ayarlar">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
