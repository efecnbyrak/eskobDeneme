    ...
    <>
      <style>{`
        ...
        .truckRoad::before {
          ...
          right: -50%;
          border-radius: 3px;
          animation: roadAnim 1.4s linear infinite;
      ...
      <div style={{
        ...
        <div className="truck-loader">
          <div className="truckWrapper">
            ...
            <svg xmlSpace="preserve" viewBox="0 0 453.459 453.459" xmlns="http://www.w3.org/2000/svg" className="lampPost" fill="#000000">
        ...
        <div>
          <h1 className="font-display" style={{ fontSize: 'clamp(3rem, 8vw, 6rem)', fontWeight: 800, color: 'var(--color-text)', lineHeight: 1, marginBottom: 8 }}>
            404
          </h1>
          <p style={{ fontSize: 'clamp(1rem, 2vw, 1.25rem)', color: 'var(--color-text-secondary)', marginBottom: 32, fontWeight: 500 }}>
            Aradığın sayfa burada değil. Belki yanlış yola girdik?
          </p>
          <Link href="/">
            <button style={{
